 ...
 */
typedef u8 MZNT_RendererType /* use as value */;
 ...
 */
typedef u8 MZNT_TextureFormat /* use as value */;
 ...
 */
MZNT_Renderer* MZNT_CreateRenderer(
    MZNT_RendererConfiguration config,
 ...
 */
MZNT_RendererSurface* MZNT_CreateRendererSurfaceFromWindow(
    MZNT_Renderer* renderer,
 ...
 */
b8 MZNT_DestroyRendererSurface(
 ...
 */
MZNT_RendererCommandBuffer* MZNT_BeginFrame(
    MZNT_RendererSurface* surface,
    f32 r,
    f32 g,
    f32 b,
 ...
 */
MZNT_SwapChain* MZNT_CreateSwapChainFromWindow(
    MZNT_Renderer* renderer,
    MZNT_WindowHandle windowHandle,
    MZNT_SwapChainConfiguration cfg,
    PNSLR_Allocator tempAllocator
);
 ...
 */
MZNT_TextureFormat MZNT_GetSwapChainTextureFormat(
    MZNT_SwapChain* swapChain
);
 ...
 */
MZNT_RendererCommandBuffer* MZNT_IterateSwapChain(
    MZNT_SwapChain* swapChain,
    u8* outImgIdx,
    PNSLR_Allocator tempAllocator
);
